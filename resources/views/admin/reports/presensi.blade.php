<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <a href="{{ route('admin.reports.presensi.pdf', request()->query()) }}" class="rounded-xl bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700">Export PDF</a>
        </div>
